...
diagnostic_CLI_args="$diagnostic_CLI_args --trainer.profiler simple --trainer.callbacks pytorch_lightning.callbacks.DeviceStatsMonitor pytorch_lightning.callbacks.LearningRateMonitor" #--trainer.track_grad_norm 2"
